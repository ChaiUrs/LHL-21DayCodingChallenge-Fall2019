...
const pumpkinSpice = money => {
  ...
  console.log("Pumpkin Pie Slices the festival-goer can buy:", pieSlices);
  console.log(
  ...
  console.log("Pumpkin Spice Lattes the festival-goer can buy:", pieLattes);
  console.log(
  ...
  console.log("Pumpkin Spice Macarons the festival-goer can buy:", pieMacarons);
  console.log(
